 ...
 */
public class EstimatedProbD2S implements DistanceMeasure, EstimatedProb {

	@Override
	/**
	 * Calcola la dissimilarità parziale per due sequenze
	 * secondo la formula D2S con la probabilità osservata
	...
	public double computePartialDistance(Parameters param) {
		...
		//mappe che contengono il conto effettivo delle lettere nelle due stringhe
		...
		//calcolo Pwx e Pwy, probabilità del kmer nella prima e nella seconda stringa
